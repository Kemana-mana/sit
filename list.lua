local Models = {
    ...
    [538002882] = { sit = { type = 'chair', seats = {[1] = vector4(0.0, 0.0, -0.10, 180.0)} } }, -- ba_prop_battle_club_chair_01
    [-829283643] = { sit = { type = 'chair', seats = {[1] = vector4(0.0, -0.1, -0.10, 180.0)} } }, -- ba_prop_battle_club_chair_02
    [-992735415] = { sit = { type = 'chair', seats = {[1] = vector4(0.0, 0.0, -0.10, 180.0)} } }, -- ba_prop_battle_club_chair_03
    ...
    [-1519439119] = {
        sit = { type = 'chair', teleportIn = true, seats = {[1] = vector4(-0.1, 0.2, 1.0, 90.0), [2] = vector4(0.1, 0.2, 1.0, 270.0), [3] = vector4(-0.01, -0.6, 1.0, 90.0), [4] = vector4(0.01, -0.6, 1.0, 270.0)} },
    ...
    [1577885496] = { sit = { type = 'chair2', seats = {[1] = vector4(0.0, 0.05, 0.55, 180.0)} } }, -- gabz_pdprops_chair02
    ...
    -- Town Hall
    [1279242633] = { 
        sit = { type = 'chair2', seats = {[1] = vector4(-0.40, 0.05, 0.5, 180.0), [2] = vector4(0.40, 0.05, 0.5, 180.0)} },
        lay = { type = 'layside', teleportIn = true, seats = {[1] = vector4(0.0, 0.05, 0.5, 180.0)} }
    }, -- gabz_townhall_bench_wait
    [-1737090544] = { 
        sit = { type = 'chair', seats = {[1] = vector4(-0.60, -0.05, -0.07, 180.0), [2] = vector4(0.0, -0.05, -0.07, 180.0), [3] = vector4(0.60, -0.05, -0.07, 180.0)} },
        lay = { type = 'layside', teleportIn = true, seats = {[1] = vector4(0.0, -0.05, -0.07, 180.0)} }
...
local PolyZones = {
    ...
    -- Vanilla Unicorn
    ['vanilla_unicorn'] = {
		enabled = false, -- set back to true
    ...
    -- Tequi-la-la
    ['tequilala'] = {
		enabled = Config.PresetLocations.tequilala,
    ...
    -- Coroner
    ['coroner'] = {
		enabled = Config.PresetLocations.coroner,
		center = vector3(265.13, -1346.60, 24.40),
		radius = 30.0,
		polys = {
            -- Autopsy Benches
            ['coroner_autopsy_1'] = { 
    ...
    ['tattoo_shops'] = {
		enabled = Config.PresetLocations.tattoo_shops,
		radius = false,
		polys = {
            ['tattoo_sandy_shores'] = { 
    ...
    -- Trevor's Trailer
    ['trevors_trailer'] = {
		enabled = Config.PresetLocations.trevors_trailer,
    ...
    ['paleto_bank'] = {
        enabled = Config.PresetLocations.paleto_bank,
    ...
    ['pdm'] = {
		enabled = Config.PresetLocations.pdm,
    ...
    -- Los Santos Customs
    ['lscustoms'] = {
		enabled = Config.PresetLocations.lscustoms,
    ...
    ['wall'] = {
		enabled = Config.PresetLocations.wall,
    ...
    -- This is only a proof of concept.
    ['steps'] = {
		enabled = Config.PresetLocations.steps,
    ...
    -- This is only a proof of concept.
    ['ledge'] = {
		enabled = Config.PresetLocations.ledge,
    ...
    -- Pillbox Hospital
    ['gabz_pillbox'] = {
        enabled = Config.PresetLocations.gabz_pillbox,
        center = vector3(333.71, -589.38, 41.98),
        radius = 50.0,
        polys = {
            -- Reception Front
            ['pillbox_recept_f_1'] = { 
            ...
            ['pillbox_ward_a_4'] = { 
                sit = { type = 'chair3', seats = {[1] = vector4(314.84, -577.27, 42.8, 338.0)} }, 
                poly = { length = 1.0, width = 1.0, height = 1.0 } 
            },
            ['pillbox_ward_a_5'] = { 
            ...
            ['pillbox_ward_b_5'] = { 
                sit = { type = 'chair3', seats = {[1] = vector4(337.88, -581.45, 42.8, 165.0)} }, 
                poly = { length = 1.0, width = 1.0, height = 1.0 } 
            },
            ['pillbox_ward_b_6'] = { 
                sit = { type = 'chair3', seats = {[1] = vector4(339.87, -582.19, 42.8, 159.0)} }, 
                poly = { length = 1.0, width = 1.0, height = 1.0 } 
            },
            ['pillbox_ward_b_7'] = { 
            ...
            ['pillbox_ward_c_8'] = { 
                sit = { type = 'chair3', seats = {[1] = vector4(358.15, -592.95, 42.8, 340.0)} }, 
                poly = { length = 1.0, width = 1.0, height = 1.0 } 
            },
            ['pillbox_ward_c_9'] = { 
            ...
            ['pillbox_ward_c_13'] = { 
                sit = { type = 'chair3', seats = {[1] = vector4(359.53, -589.45, 42.8, 160.0)} }, 
                poly = { length = 1.0, width = 1.0, height = 1.0 } 
            },
            ['pillbox_ward_c_14'] = { 
                sit = { type = 'chair3', seats = {[1] = vector4(357.48, -588.70, 42.8, 160.0)} }, 
                poly = { length = 1.0, width = 1.0, height = 1.0 } 
            },
            ['pillbox_ward_c_15'] = { 
    ...
    ['gabz_mrpd'] = {
        enabled = Config.PresetLocations.gabz_mrpd,
    ...
    -- Sandy Shores Sheriff's Office
    ['gabz_sandy_so'] = {
        enabled = Config.PresetLocations.gabz_sandy_so,
        ...
        polys = {
            ...
            -- Cell #3
            ['sandy_so_cell_3_bed'] = {
                sit = { type = 'chair2', seats = {[1] = vector4(1807.31, 3679.10, 33.67, 30.0), [2] = vector4(1806.83, 3678.83, 33.67, 30.0), [3] = vector4(1806.35, 3678.55, 33.67, 30.0)} },
                lay = { type = 'layside', seats = {[1] = vector4(1806.83, 3678.83, 33.67, 30.0)} },
                poly = { center = vector3(1806.83, 3678.83, 33.67), length = 0.85, width = 2.2, height = 0.8 } 
            },
    ...
    -- Pop's Diner
    ['gabz_diner'] = {
        enabled = Config.PresetLocations.gabz_diner,
    ...
    ['gabz_pacific_standard_old'] = {
        enabled = Config.PresetLocations.gabz_pacific_standard_old,
    ...
    -- Pacific Standard (New)
    ['gabz_pacific_standard'] = {
        enabled = Config.PresetLocations.gabz_pacific_standard,
        center = vector3(258.88, 219.10, 107.50),
        radius = 35.0,
        polys = {
            ['ps_seats_1'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(237.59, 220.38, 105.78, 250.0), [2] = vector4(237.87, 221.14, 105.78, 250.0)} }, 
                lay = { type = 'layside', seats = {[1] = vector4(237.73, 220.76, 105.78, 250.0)} },
                poly = { center = vector3(237.73, 220.76, 105.78), length = 0.75, width = 1.85, height = 1.0 } 
            },
            ['ps_seats_2'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(238.51, 222.94, 105.78, 250.0), [2] = vector4(238.79, 223.70, 105.78, 250.0)} }, 
                lay = { type = 'layside', seats = {[1] = vector4(238.65, 223.32, 105.78, 250.0)} },
                poly = { center = vector3(238.65, 223.32, 105.78), length = 0.75, width = 1.85, height = 1.0 } 
            },
            ['ps_seats_3'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(236.85, 221.50, 105.78, 70.0), [2] = vector4(236.57, 220.74, 105.78, 70.0)} }, 
                lay = { type = 'layside', seats = {[1] = vector4(236.71, 221.12, 105.78, 70.0)} },
                poly = { center = vector3(236.71, 221.12, 105.78), length = 0.75, width = 1.85, height = 1.0 } 
            },
            ['ps_seats_4'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(237.78, 224.05, 105.78, 70.0), [2] = vector4(237.50, 223.29, 105.78, 70.0)} }, 
                lay = { type = 'layside', seats = {[1] = vector4(237.64, 223.67, 105.78, 70.0)} },
                poly = { center = vector3(237.64, 223.67, 105.78), length = 0.75, width = 1.85, height = 1.0 } 
            },
            ['ps_seats_5'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(244.68, 217.62, 105.78, 340.0), [2] = vector4(243.92, 217.90, 105.78, 340.0)} }, 
                lay = { type = 'layside', seats = {[1] = vector4(244.30, 217.76, 105.78, 340.0)} },
                poly = { center = vector3(244.30, 217.76, 105.78), length = 0.75, width = 1.85, height = 1.0 } 
            },
            ['ps_seats_6'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(249.37, 232.96, 105.78, 160.0), [2] = vector4(250.13, 232.68, 105.78, 160.0)} }, 
                lay = { type = 'layside', seats = {[1] = vector4(249.75, 232.82, 105.78, 160.0)} },
                poly = { center = vector3(249.75, 232.82, 105.78), length = 0.75, width = 1.85, height = 1.0 } 
            },
            ['ps_seats_7'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(281.59, 213.13, 102.74, 70.0), [2] = vector4(281.31, 212.37, 102.74, 70.0)} }, 
                lay = { type = 'layside', seats = {[1] = vector4(281.45, 212.75, 102.74, 70.0)} },
                poly = { center = vector3(281.45, 212.75, 102.74), length = 0.75, width = 1.85, height = 1.0 } 
            },
            ['ps_seats_8'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(268.21, 208.98, 109.67, 340.0), [2] = vector4(267.45, 209.26, 109.67, 340.0)} }, 
                lay = { type = 'layside', seats = {[1] = vector4(267.83, 209.12, 109.67, 340.0)} },
                poly = { center = vector3(267.83, 209.12, 109.67), length = 0.75, width = 1.85, height = 1.0 } 
            },
            ['ps_seats_9'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(258.74, 212.42, 109.67, 340.0), [2] = vector4(257.98, 212.70, 109.67, 340.0)} }, 
                lay = { type = 'layside', seats = {[1] = vector4(258.36, 212.56, 109.67, 340.0)} },
                poly = { center = vector3(258.36, 212.56, 109.67), length = 0.75, width = 1.85, height = 1.0 } 
            },
            ['ps_seats_10'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(263.50, 227.84, 109.67, 160.0), [2] = vector4(264.26, 227.56, 109.67, 160.0)} }, 
                lay = { type = 'layside', seats = {[1] = vector4(263.88, 227.70, 109.67, 160.0)} },
                poly = { center = vector3(263.88, 227.70, 109.67), length = 0.75, width = 1.85, height = 1.0 } 
            },
            ['ps_seats_11'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(272.89, 224.43, 109.67, 160.0), [2] = vector4(273.65, 224.15, 109.67, 160.0)} }, 
                lay = { type = 'layside', seats = {[1] = vector4(273.27, 224.29, 109.67, 160.0)} },
                poly = { center = vector3(273.27, 224.29, 109.67), length = 0.75, width = 1.85, height = 1.0 } 
            },

            -- Boss Office
            ['ps_office_1'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(280.24, 213.18, 109.67, 85.0)} }, 
                poly = { length = 0.9, width = 0.9, height = 1.8 } 
            },
            ['ps_office_2'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(277.61, 215.00, 109.67, 235.0)} }, 
                poly = { length = 1.1, width = 1.1, height = 1.2 } 
            },
            ['ps_office_3'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(277.02, 213.44, 109.67, 260.0)} }, 
                poly = { length = 1.1, width = 1.1, height = 1.2 } 
            }
        }
    },
    ...
    ['gabz_park_ranger'] = {
		enabled = Config.PresetLocations.gabz_park_ranger,
		...
		polys = {
            ...
            ['park_ranger_bench'] = { 
                ...
                poly = { length = 0.65, width = 1.15, height = 1.25 } 
            },
            ...
            -- Upstairs
            ['park_ranger_chair_1'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(382.83, 797.80, 190.0, 350.0)} }, 
                poly = { length = 0.65, width = 0.65, height = 1.0 } 
            },
            ['park_ranger_chair_2'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(383.97, 799.41, 190.0, 150.0)} }, 
                poly = { length = 0.65, width = 0.65, height = 1.0 } 
            }
        }
    },
    ...
    -- Studio
    ['gabz_records'] = {
		enabled = Config.PresetLocations.gabz_records,
    ...
    -- Tuners
    ['gabz_tuners'] = {
		enabled = Config.PresetLocations.gabz_tuners,
    ...
    -- Paleto Bay Sheriff's Office
    ['gabz_paleto_so'] = {
		enabled = Config.PresetLocations.gabz_paleto_so,
    ...
    ['gabz_lamesa_pd'] = {
        enabled = Config.PresetLocations.gabz_lamesa_pd,
    ...
    -- Hayes Auto
    ['gabz_hayes'] = {
		enabled = Config.PresetLocations.gabz_hayes,
    ...
    -- Import Garage
    ['gabz_import'] = {
		enabled = Config.PresetLocations.gabz_import,
		center = vector3(940.10, -964.13, 38.94),
		radius = 40.0,
		polys = {
            ['import_couch'] = { 
    ...
    ['gabz_prison'] = { 
		enabled = Config.PresetLocations.gabz_prison,
    ...
    -- Premium Deluxe Motorsport
    ['gabz_pdm'] = {
		enabled = Config.PresetLocations.gabz_pdm,
    ...
    -- Harmony Repairs
    ['gabz_harmony'] = {
		enabled = Config.PresetLocations.gabz_harmony,
    ...
    ['gabz_lscustoms'] = {
		enabled = Config.PresetLocations.gabz_lscustoms,
    ...
    -- ['gabz_beanmachine'] = {
	-- 	enabled = Config.PresetLocations.gabz_beanmachine,
    ...
    -- Pizza This...
    ['gabz_pizzeria'] = {
		enabled = Config.PresetLocations.gabz_pizzeria,
		...
		polys = {
            ...
            ['pizzeria_toilet_2'] = { 
                ...
                poly = { length = 0.65, width = 0.45, height = 1.0 } 
            },
            ['pizzeria_toilet_3'] = { 
    ...
    -- HATers
    ['gabz_haters'] = {
		enabled = Config.PresetLocations.gabz_haters,
		...
		polys = {
            ...
            ['haters_toilet'] = { 
                ...
                poly = { length = 0.75, width = 0.5, height = 1.25 } 
            }
        }
    },
    ...
    -- UwU Cafe
    ['gabz_catcafe'] = {
		enabled = Config.PresetLocations.gabz_catcafe,
		center = vector3(-577.38, -1061.33, 22.98),
		radius = 30.0,
		polys = {
            -- Window Area (Downstairs)
            ['catcafe_window_1'] = { 
                sit = { type = 'chair', teleportIn = true, seats = {[1] = vector4(-576.90, -1069.28, 22.05, 0.0)} },
                poly = { center = vector3(-576.90, -1069.28, 22.05), length = 0.8, width = 0.8, height = 1.0 } 
            },
            ['catcafe_window_2'] = { 
                sit = { type = 'chair', teleportIn = true, seats = {[1] = vector4(-577.80, -1069.28, 22.05, 0.0)} },
                poly = { center = vector3(-577.80, -1069.28, 22.05), length = 0.8, width = 0.8, height = 1.0 } 
            },
            ['catcafe_window_3'] = { 
                sit = { type = 'laysit', teleportIn = true, seats = {[1] = vector4(-579.36, -1069.22, 22.05, 270.0)} },
                poly = { center = vector3(-579.15, -1069.28, 22.05), length = 1.65, width = 0.8, height = 1.0 } 
            },
            ['catcafe_window_4'] = { 
                sit = { type = 'chair', teleportIn = true, seats = {[1] = vector4(-583.0, -1069.28, 22.05, 0.0)} },
                poly = { center = vector3(-583.0, -1069.28, 22.05), length = 0.8, width = 0.8, height = 1.0 } 
            },
            ['catcafe_window_5'] = { 
                sit = { type = 'chair', teleportIn = true, seats = {[1] = vector4(-583.90, -1069.28, 22.05, 0.0)} },
                poly = { center = vector3(-583.90, -1069.28, 22.05), length = 0.8, width = 0.8, height = 1.0 } 
            },
            ['catcafe_window_6'] = { 
                sit = { type = 'laysit', teleportIn = true, seats = {[1] = vector4(-585.48, -1069.22, 22.05, 270.0)} },
                poly = { center = vector3(-585.30, -1069.28, 22.05), length = 1.65, width = 0.8, height = 1.0 } 
            },

            -- Window Area (Upstairs)
            ['catcafe_window_7'] = { 
                sit = { type = 'chair', teleportIn = true, seats = {[1] = vector4(-576.90, -1069.28, 26.32, 0.0)} },
                poly = { center = vector3(-576.90, -1069.28, 26.32), length = 0.8, width = 0.8, height = 1.0 } 
            },
            ['catcafe_window_8'] = { 
                sit = { type = 'chair', teleportIn = true, seats = {[1] = vector4(-577.80, -1069.28, 26.32, 0.0)} },
                poly = { center = vector3(-577.80, -1069.28, 26.32), length = 0.8, width = 0.8, height = 1.0 } 
            },
            ['catcafe_window_9'] = { 
                sit = { type = 'laysit', teleportIn = true, seats = {[1] = vector4(-579.36, -1069.22, 26.32, 270.0)} },
                poly = { center = vector3(-579.15, -1069.28, 26.32), length = 1.65, width = 0.8, height = 1.0 } 
            },

            -- Booths
            ['catcafe_booth_1'] = { 
                sit = { type = 'diner_booth', seats = {[1] = vector4(-573.10, -1068.10, 22.0, 0.0), [2] = vector4(-574.0, -1068.10, 22.0, 0.0)} },
                poly = { center = vector3(-573.60, -1068.10, 22.0), length = 0.8, width = 2.3, height = 1.0 } 
            },
            ['catcafe_booth_2'] = { 
                sit = { type = 'diner_booth', seats = {[1] = vector4(-573.10, -1066.02, 22.0, 180.0), [2] = vector4(-574.0, -1066.02, 22.0, 180.0)} },
                poly = { center = vector3(-573.60, -1066.02, 22.0), length = 0.8, width = 2.3, height = 1.0 } 
            },
            ['catcafe_booth_3'] = { 
                sit = { type = 'diner_booth', seats = {[1] = vector4(-573.10, -1064.45, 22.0, 0.0), [2] = vector4(-574.0, -1064.45, 22.0, 0.0)} },
                poly = { center = vector3(-573.60, -1064.45, 22.0), length = 0.8, width = 2.3, height = 1.0 } 
            },
            ['catcafe_booth_4'] = { 
                sit = { type = 'diner_booth', seats = {[1] = vector4(-573.10, -1062.36, 22.0, 180.0), [2] = vector4(-574.0, -1062.36, 22.0, 180.0)} },
                poly = { center = vector3(-573.60, -1062.36, 22.0), length = 0.8, width = 2.3, height = 1.0 } 
            },
            ['catcafe_booth_5'] = { 
                sit = { type = 'diner_booth', seats = {[1] = vector4(-573.10, -1060.80, 22.0, 0.0), [2] = vector4(-574.0, -1060.80, 22.0, 0.0)} },
                poly = { center = vector3(-573.60, -1060.80, 22.0), length = 0.8, width = 2.3, height = 1.0 } 
            },
            ['catcafe_booth_6'] = { 
                sit = { type = 'diner_booth', seats = {[1] = vector4(-573.10, -1058.73, 22.0, 180.0), [2] = vector4(-574.0, -1058.73, 22.0, 180.0)} },
                poly = { center = vector3(-573.60, -1058.73, 22.0), length = 0.8, width = 2.3, height = 1.0 } 
            },

            -- Tree Bench
            ['catcafe_tree_bench'] = { 
                sit = { type = 'chair', skipSeeCheck = true, seats = {[1] = vector4(-579.67, -1062.20, 21.84, 0.0), [2] = vector4(-580.55, -1062.56, 21.84, 45.0), [3] = vector4(-580.92, -1063.45, 21.84, 90.0), [4] = vector4(-580.55, -1064.33, 21.84, 135.0), [5] = vector4(-579.67, -1064.70, 21.84, 180.0), [6] = vector4(-578.78, -1064.33, 21.84, 225.0), [7] = vector4(-578.42, -1063.45, 21.84, 270.0), [8] = vector4(-578.78, -1062.56, 21.84, 315.0)} },
                poly = { type = 'circle', center = vector3(-579.67, -1063.45, 21.55), radius = 1.65, height = 1.0 } 
            },

            -- Toilets
            ['catcafe_toilet_1'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(-569.22, -1051.45, 21.85, 180.0)} },
                poly = { length = 0.6, width = 0.6, height = 1.0 } 
            },
            ['catcafe_toilet_2'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(-569.22, -1057.0, 21.85, 0.0)} },
                poly = { length = 0.6, width = 0.6, height = 1.0 } 
            },

            -- Sofas
            ['catcafe_sofa_1'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(-591.31, -1049.15, 21.84, 180.0), [2] = vector4(-590.56, -1049.15, 21.84, 180.0), [3] = vector4(-589.81, -1049.15, 21.84, 180.0)} },
                poly = { center = vector3(-590.56, -1049.15, 21.84), length = 1.0, width = 3.0, height = 1.0 } 
            },
            ['catcafe_sofa_2'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(-573.62, -1053.62, 26.12, 270.0), [2] = vector4(-573.62, -1052.87, 26.12, 270.0), [3] = vector4(-573.62, -1052.12, 26.12, 270.0)} },
                poly = { center = vector3(-573.62, -1052.87, 26.12), length = 1.0, width = 3.0, height = 1.0 } 
            },
            ['catcafe_sofa_3'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(-578.75, -1058.00, 26.12, 180.0), [2] = vector4(-578.00, -1058.00, 26.12, 180.0), [3] = vector4(-577.25, -1058.00, 26.12, 180.0)} },
                poly = { center = vector3(-578.00, -1058.00, 26.12), length = 1.0, width = 3.0, height = 1.0 } 
            },

            -- Long Sofa
            ['catcafe_longsofa_1'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(-569.85, -1066.20, 26.12, 90.0), [2] = vector4(-569.85, -1066.95, 26.12, 90.0), [3] = vector4(-569.85, -1067.78, 26.12, 90.0), [4] = vector4(-569.85, -1068.55, 26.12, 90.0)} },
                lay = { type = 'layside_reverse', seats = {[1] = vector4(-569.70, -1066.65, 26.12, 90.0)} },
                poly = { center = vector3(-569.7, -1067.25, 26.12), length = 1.15, width = 3.25, height = 1.0 }
            },
            ['catcafe_longsofa_2'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(-571.25, -1069.25, 26.12, 0.0), [2] = vector4(-572.15, -1069.25, 26.12, 0.0), [3] = vector4(-572.95, -1069.25, 26.12, 0.0) } },
                lay = { type = 'layside', seats = {[1] = vector4(-572.50, -1069.35, 26.12, 0.0)} },
                poly = { center = vector3(-571.95, -1069.45, 26.12), length = 1.25, width = 3.25, height = 1.0 } 
            },

            -- Armchairs
            ['catcafe_armchair_1'] = { 
                sit = { type = 'chair', skipSeeCheck = true, seats = {[1] = vector4(-579.71, -1052.47, 21.85, 330.0)} },
                poly = { length = 1.2, width = 1.2, height = 1.5 } 
            },
            ['catcafe_armchair_2'] = { 
                sit = { type = 'chair', skipSeeCheck = true, seats = {[1] = vector4(-580.82, -1051.22, 21.85, 283.0)} },
                poly = { length = 1.2, width = 1.2, height = 1.5 } 
            },
            ['catcafe_armchair_3'] = { 
                sit = { type = 'chair', skipSeeCheck = true, seats = {[1] = vector4(-577.58, -1052.55, 21.85, 40.0)} },
                poly = { length = 1.2, width = 1.2, height = 1.5 } 
            },
            ['catcafe_armchair_4'] = { 
                sit = { type = 'chair', skipSeeCheck = true, seats = {[1] = vector4(-576.85, -1051.0, 21.85, 105.0)} },
                poly = { length = 1.2, width = 1.2, height = 1.5 } 
            },

            ['catcafe_fireplace_1'] = { 
                sit = { type = 'chair', skipSeeCheck = true, teleportIn = true, seats = {[1] = vector4(-583.50, -1049.70, 22.13, 180.0)} },
                poly = { center = vector3(-583.50, -1049.38, 22.13), length = 1.2, width = 1.2, height = 1.0 } 
            },
            ['catcafe_fireplace_2'] = { 
                sit = { type = 'laysit', skipSeeCheck = true, teleportIn = true, seats = {[1] = vector4(-582.25, -1049.40, 22.13, 90.0)} },
                poly = { center = vector3(-582.25, -1049.38, 22.13), length = 1.2, width = 1.2, height = 1.0 } 
            }
        }
    },
    ...
    ['gabz_vanilla_unicorn'] = {
		enabled = Config.PresetLocations.gabz_vanilla_unicorn,
		center = vector3(115.41, -1290.70, 28.08),
		radius = 30.0,
		polys = {
            -- Back room
            ['vu_stool_1'] = { 
            ...
            -- Boss Room
            ['vu_boss_sofa'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(98.04, -1289.26, 28.76, 121.0), [2] = vector4(98.43, -1289.90, 28.76, 121.0), [3] = vector4(98.82, -1290.54, 28.76, 121.0)} }, 
                lay = { type = 'layside', teleportIn = true, seats = {[1] = vector4(98.43, -1289.90, 28.76, 121.0)} }, 
                poly = { center = vector3(98.50, -1289.86, 28.76), length = 1.0, width = 3.0, height = 1.0 } 
            },

            -- Premium Lounge
            ['vu_premium_lounge_1'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(116.02, -1303.27, 28.76, 120.0)} }, 
                poly = { length = 0.75, width = 1.0, height = 1.0 } 
            },
            ['vu_premium_lounge_2'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(116.33, -1304.30, 28.76, 75.0)} }, 
                poly = { length = 0.75, width = 1.0, height = 1.0 } 
            },
            ['vu_premium_lounge_3'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(115.55, -1305.02, 28.76, 30.0)} }, 
                poly = { length = 0.75, width = 1.0, height = 1.0 } 
            },
            ['vu_premium_lounge_4'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(113.73, -1306.08, 28.76, 30.0)} }, 
                poly = { length = 0.75, width = 1.0, height = 1.0 } 
            },
            ['vu_premium_lounge_5'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(112.71, -1306.41, 28.76, 345.0)} }, 
                poly = { length = 0.75, width = 1.0, height = 1.0 } 
            },
            ['vu_premium_lounge_6'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(112.00, -1305.63, 28.76, 300.0)} }, 
                poly = { length = 0.75, width = 1.0, height = 1.0 } 
            },
            ['vu_premium_lounge_7'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(110.54, -1303.12, 28.76, 300.0)} }, 
                poly = { length = 0.75, width = 1.0, height = 1.0 } 
            },
            ['vu_premium_lounge_8'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(110.25, -1302.10, 28.76, 255.0)} }, 
                poly = { length = 0.75, width = 1.0, height = 1.0 } 
            },
            ['vu_premium_lounge_9'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(110.98, -1301.35, 28.76, 210.0), [2] = vector4(111.85, -1300.85, 28.76, 210.0), [3] = vector4(112.72, -1300.35, 28.76, 210.0)} }, 
                lay = { type = 'layside_reverse', teleportIn = true, seats = {[1] = vector4(111.42, -1301.10, 28.76, 210.0)} }, 
                poly = { center = vector3(111.85, -1300.85, 28.76), length = 0.75, width = 3.05, height = 1.0 } 
            },

            -- Strip Watch
            ['vu_strip_watch_1'] = { 
                sit = { type = 'strip_watch', skipSeeCheck = true, seats = {[1] = vector4(108.12, -1293.32, 27.76, 30.0)} }, 
                poly = { length = 1.1, width = 1.0, height = 1.0 } 
            },
            ['vu_strip_watch_2'] = { 
                sit = { type = 'strip_watch', skipSeeCheck = true, seats = {[1] = vector4(109.82, -1292.38, 27.76, 30.0)} }, 
                poly = {length = 1.1, width = 1.0, height = 1.0 } 
            },
            ['vu_strip_watch_3'] = { 
                sit = { type = 'strip_watch', skipSeeCheck = true, seats = {[1] = vector4(111.55, -1290.79, 27.76, 65.0)} }, 
                poly = { length = 1.1, width = 1.0, height = 1.0 } 
            },
            ['vu_strip_watch_4'] = { 
                sit = { type = 'strip_watch', skipSeeCheck = true, seats = {[1] = vector4(111.80, -1288.52, 27.76, 100.0)} }, 
                poly = { length = 1.1, width = 1.0, height = 1.0 } 
            },
            ['vu_strip_watch_5'] = { 
                sit = { type = 'strip_watch', skipSeeCheck = true, seats = {[1] = vector4(110.61, -1286.81, 27.76, 140.0)} }, 
                poly = { length = 1.1, width = 1.0, height = 1.0 } 
            },
            ['vu_strip_watch_6'] = { 
                sit = { type = 'strip_watch', skipSeeCheck = true, seats = {[1] = vector4(108.49, -1286.21, 27.76, 180.0)} }, 
                poly = { length = 1.1, width = 1.0, height = 1.0 } 
            },
            ['vu_strip_watch_7'] = { 
                sit = { type = 'strip_watch', skipSeeCheck = true, seats = {[1] = vector4(106.44, -1286.86, 27.76, 205.0)} }, 
                poly = { length = 1.1, width = 1.0, height = 1.0 } 
            },
            ['vu_strip_watch_8'] = { 
                sit = { type = 'strip_watch', skipSeeCheck = true, seats = {[1] = vector4(104.82, -1287.78, 27.76, 210.0)} }, 
                poly = { length = 1.1, width = 1.0, height = 1.0 } 
            },

            -- Lounge
            ['vu_lounge_1'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(117.24, -1292.71, 27.76, 30.0)} }, 
                poly = { length = 0.8, width = 1.0, height = 1.0 } 
            },
            ['vu_lounge_2'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(116.23, -1293.03, 27.76, 345.0)} }, 
                poly = { length = 0.8, width = 1.0, height = 1.0 } 
            },
            ['vu_lounge_3'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(115.50, -1292.28, 27.76, 300.0)} }, 
                poly = { length = 0.8, width = 1.0, height = 1.0 } 
            },

            ['vu_lounge_4'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(111.40, -1281.87, 27.76, 230.0)} }, 
                poly = { length = 0.7, width = 0.75, height = 1.0 } 
            },
            ['vu_lounge_5'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(112.16, -1281.36, 27.76, 200.0)} }, 
                poly = { length = 0.7, width = 0.75, height = 1.0 } 
            },
            ['vu_lounge_6'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(113.05, -1281.26, 27.76, 172.0)} }, 
                poly = { length = 0.7, width = 0.75, height = 1.0 } 
            },
            ['vu_lounge_7'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(113.90, -1281.62, 27.76, 145.0)} }, 
                poly = { length = 0.7, width = 0.75, height = 1.0 } 
            },
            ['vu_lounge_8'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(114.47, -1282.32, 27.76, 115.0)} }, 
                poly = { length = 0.7, width = 0.75, height = 1.0 } 
            },
            ['vu_lounge_9'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(114.63, -1283.20, 27.76, 90.0)} }, 
                poly = { length = 0.7, width = 0.75, height = 1.0 } 
            },
            ['vu_lounge_10'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(114.37, -1284.05, 27.76, 60.0)} }, 
                poly = { length = 0.7, width = 0.75, height = 1.0 } 
            },
            ['vu_lounge_11'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(113.74, -1284.69, 27.76, 32.0)} }, 
                poly = { length = 0.7, width = 0.75, height = 1.0 } 
            },

            ['vu_lounge_12'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(117.39, -1285.73, 27.76, 125.0)} }, 
                poly = { length = 0.7, width = 0.75, height = 1.0 } 
            },
            ['vu_lounge_13'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(117.70, -1286.59, 27.76, 95.0)} }, 
                poly = { length = 0.7, width = 0.75, height = 1.0 } 
            },
            ['vu_lounge_14'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(117.61, -1287.47, 27.76, 70.0)} }, 
                poly = { length = 0.7, width = 0.75, height = 1.0 } 
            },
            ['vu_lounge_15'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(117.07, -1288.22, 27.76, 40.0)} }, 
                poly = { length = 0.7, width = 0.75, height = 1.0 } 
            },
            ['vu_lounge_16'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(116.28, -1288.62, 27.76, 15.0)} }, 
                poly = { length = 0.7, width = 0.75, height = 1.0 } 
            },
            ['vu_lounge_17'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(115.38, -1288.59, 27.76, 345.0)} }, 
                poly = { length = 0.7, width = 0.75, height = 1.0 } 
            },

            ['vu_lounge_18'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(115.83, -1283.89, 27.76, 297.0)} }, 
                poly = { length = 0.7, width = 0.75, height = 1.0 } 
            },
            ['vu_lounge_19'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(115.64, -1283.01, 27.76, 270.0)} }, 
                poly = { length = 0.7, width = 0.75, height = 1.0 } 
            },
            ['vu_lounge_21'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(115.84, -1282.13, 27.76, 240.0)} }, 
                poly = { length = 0.7, width = 0.75, height = 1.0 } 
            },
            ['vu_lounge_22'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(116.48, -1281.48, 27.76, 215.0)} }, 
                poly = { length = 0.7, width = 0.75, height = 1.0 } 
            },
            ['vu_lounge_23'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(117.32, -1281.17, 27.76, 185.0)} }, 
                poly = { length = 0.7, width = 0.75, height = 1.0 } 
            },
            ['vu_lounge_24'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(118.23, -1281.30, 27.76, 155.0)} }, 
                poly = { length = 0.7, width = 0.75, height = 1.0 } 
            },
            ['vu_lounge_25'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(118.96, -1281.85, 27.76, 128.0)} }, 
                poly = { length = 0.7, width = 0.75, height = 1.0 } 
            },
            ['vu_lounge_26'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(119.33, -1282.67, 27.76, 100.0)} }, 
                poly = { length = 0.7, width = 0.75, height = 1.0 } 
            },

            ['vu_lounge_27'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(120.25, -1284.22, 27.76, 210.0), [2] = vector4(120.85, -1283.85, 27.76, 210.0)} }, 
                poly = { center = vector3(120.86, -1283.87, 27.76), length = 0.8, width = 1.75, height = 1.0 } 
            },
            ['vu_lounge_28'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(121.91, -1284.19, 27.76, 120.0), [2] = vector4(122.31, -1284.89, 27.76, 120.0)} }, 
                lay = { type = 'layside', teleportIn = true, seats = {[1] = vector4(122.11, -1284.54, 27.76, 120.0)} }, 
                poly = { center = vector3(122.11, -1284.54, 27.76), length = 0.8, width = 1.75, height = 1.0 } 
            },
            ['vu_lounge_29'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(122.08, -1285.97, 27.76, 30.0), [2] = vector4(121.47, -1286.32, 27.76, 30.0)} }, 
                poly = { length = 0.8, width = 1.75, height = 1.0 } 
            },
            ['vu_lounge_30'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(123.10, -1286.71, 27.76, 165.0)} }, 
                poly = { length = 0.7, width = 0.65, height = 1.0 } 
            },
            ['vu_lounge_31'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(123.60, -1287.13, 27.76, 120.0), [2] = vector4(124.00, -1287.83, 27.76, 120.0)} }, 
                lay = { type = 'layside', teleportIn = true, seats = {[1] = vector4(123.80, -1287.48, 27.76, 120.0)} }, 
                poly = { center = vector3(123.80, -1287.48, 27.76), length = 0.7, width = 1.25, height = 1.0 } 
            },
            ['vu_lounge_32'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(124.13, -1288.48, 27.76, 75.0)} }, 
                poly = { length = 0.7, width = 0.65, height = 1.0 } 
            },
            ['vu_lounge_33'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(123.37, -1289.18, 27.76, 30.0)} }, 
                poly = { length = 0.7, width = 1.0, height = 1.0 } 
            },

            -- Booth #1
            ['vu_booth_1'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(124.34, -1293.77, 28.76, 120.0), [2] = vector4(124.84, -1294.63, 28.76, 120.0)} }, 
                lay = { type = 'layside', teleportIn = true, seats = {[1] = vector4(124.59, -1294.20, 28.76, 120.0)} }, 
                poly = { center = vector3(124.59, -1294.20, 28.76), length = 0.75, width = 2.05, height = 1.0 } 
            },
            ['vu_booth_2'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(124.52, -1295.84, 28.76, 30.0), [2] = vector4(123.66, -1296.34, 28.76, 30.0)} }, 
                lay = { type = 'layside', teleportIn = true, seats = {[1] = vector4(124.09, -1296.09, 28.76, 30.0)} }, 
                poly = { center = vector3(124.09, -1296.09, 28.76), length = 0.75, width = 2.05, height = 1.0 } 
            },
            ['vu_booth_3'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(122.46, -1296.02, 28.76, 300.0), [2] = vector4(121.96, -1295.16, 28.76, 300.0)} }, 
                lay = { type = 'layside_reverse', teleportIn = true, seats = {[1] = vector4(122.21, -1295.59, 28.76, 300.0)} }, 
                poly = { center = vector3(122.21, -1295.59, 28.76), length = 0.75, width = 2.05, height = 1.0 } 
            },

            -- Booth #2
            ['vu_booth_4'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(120.95, -1295.74, 28.76, 120.0), [2] = vector4(121.45, -1296.60, 28.76, 120.0)} }, 
                lay = { type = 'layside', teleportIn = true, seats = {[1] = vector4(121.20, -1296.17, 28.76, 120.0)} }, 
                poly = { center = vector3(121.20, -1296.17, 28.76), length = 0.75, width = 2.05, height = 1.0 } 
            },
            ['vu_booth_5'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(121.13, -1297.81, 28.76, 30.0), [2] = vector4(120.27, -1298.31, 28.76, 30.0)} }, 
                lay = { type = 'layside', teleportIn = true, seats = {[1] = vector4(120.70, -1298.06, 28.76, 30.0)} }, 
                poly = { center = vector3(120.70, -1298.06, 28.76), length = 0.75, width = 2.0, height = 1.0 } 
            },
            ['vu_booth_6'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(119.06, -1297.98, 28.76, 300.0), [2] = vector4(118.56, -1297.12, 28.76, 300.0)} }, 
                lay = { type = 'layside_reverse', teleportIn = true, seats = {[1] = vector4(118.81, -1297.55, 28.76, 300.0)} }, 
                poly = { center = vector3(118.81, -1297.55, 28.76), length = 0.75, width = 2.05, height = 1.0 } 
            },

            -- DJ Room
            ['vu_dj_sofa'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(124.02, -1279.51, 28.76, 210.0), [2] = vector4(125.06, -1278.91, 28.76, 210.0)} }, 
                lay = { type = 'layside', teleportIn = true, seats = {[1] = vector4(124.54, -1279.21, 28.76, 210.0)} }, 
                poly = { center = vector3(124.54, -1279.21, 28.76), length = 1.0, width = 3.0, height = 1.0 } 
            }
        }
    },
    ...
    -- Townhall
    ['gabz_townhall'] = {
		enabled = Config.PresetLocations.gabz_townhall,
		center = vector3(-557.45, -216.88, 37.04),
		radius = 50.0,
		polys = {
            -- Judge
            ['townhall_judge_1'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(-585.50, -207.06, 37.73, 40.0)} },
                poly = { length = 1.0, width = 1.0, height = 1.0 } 
            },
            ['townhall_judge_2'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(-586.81, -207.75, 37.73, 20.0)} },
                poly = { length = 1.0, width = 1.0, height = 1.0 } 
            },

            -- Mayor's Office
            ['townhall_mayor_1'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(-529.53, -190.45, 42.87, 310.0)} },
                poly = { length = 1.0, width = 1.0, height = 1.0 } 
            },
            ['townhall_mayor_2'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(-530.42, -188.84, 42.87, 290.0)} },
                poly = { length = 1.0, width = 1.0, height = 1.0 } 
            },

            -- Holding Cell #1
            ['townhall_cell_1_toilet'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(-556.07, -235.48, 33.77, 30.0)} },
                poly = { length = 0.8, width = 0.8, height = 1.0 } 
            },
            ['townhall_cell_1_bed'] = {
                sit = { type = 'chair2', seats = {[1] = vector4(-557.94, -234.37, 33.77, 120.0), [2] = vector4(-557.59, -234.98, 33.77, 120.0), [3] = vector4(-557.24, -235.59, 33.77, 120.0)} },
                lay = { type = 'layside', seats = {[1] = vector4(-557.50, -234.93, 33.77, 120.0)} },
                poly = { center = vector3(-557.59, -234.98, 33.77), length = 0.85, width = 2.2, height = 0.8 } 
            },

            -- Holding Cell #2
            ['townhall_cell_2_toilet'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(-558.68, -236.95, 33.77, 30.0)} },
                poly = { length = 0.8, width = 0.8, height = 1.0 } 
            },
            ['townhall_cell_2_bed'] = {
                sit = { type = 'chair2', seats = {[1] = vector4(-555.37, -232.89, 33.77, 120.0), [2] = vector4(-555.02, -233.50, 33.77, 120.0), [3] = vector4(-554.67, -234.11, 33.77, 120.0)} },
                lay = { type = 'layside', seats = {[1] = vector4(-554.93, -233.45, 33.77, 120.0)} },
                poly = { center = vector3(-555.02, -233.50, 33.77), length = 0.85, width = 2.2, height = 0.8 } 
            }
        }
    },
    ...
    -- Otto's
    ['gabz_ottos'] = {
		enabled = Config.PresetLocations.gabz_ottos,
		center = vector3(818.21, -827.43, 25.83),
		radius = 30.0,
		polys = {
            -- Otto's Autos
            ['ottos_sofa_1'] = {
                sit = { type = 'chair2', seats = {[1] = vector4(829.60, -829.89, 25.83, 0.0), [2] = vector4(828.80, -829.89, 25.83, 0.0)} },
                lay = { type = 'layside', seats = {[1] = vector4(829.20, -829.89, 25.83, 0.0)} },
                poly = { center = vector3(829.20, -829.89, 25.83), length = 0.85, width = 2.2, height = 0.8 } 
            },
            ['ottos_sofa_2'] = {
                sit = { type = 'chair2', seats = {[1] = vector4(825.45, -829.89, 25.83, 0.0), [2] = vector4(824.65, -829.89, 25.83, 0.0)} },
                lay = { type = 'layside', seats = {[1] = vector4(825.05, -829.89, 25.83, 0.0)} },
                poly = { center = vector3(825.05, -829.89, 25.83), length = 0.85, width = 2.2, height = 0.8 } 
            },
            ['ottos_sofa_3'] = {
                sit = { type = 'chair2', seats = {[1] = vector4(831.30, -826.52, 25.83, 270.0), [2] = vector4(831.30, -825.72, 25.83, 270.0)} },
                lay = { type = 'layside', seats = {[1] = vector4(831.30, -826.12, 25.83, 270.0)} },
                poly = { center = vector3(831.30, -826.12, 25.83), length = 0.85, width = 2.2, height = 0.8 } 
            },

            -- Otto's Cardealers
            ['ottos_sofa_4'] = {
                sit = { type = 'chair2', seats = {[1] = vector4(799.43, -825.36, 25.83, 90.0), [2] = vector4(799.43, -826.16, 25.83, 90.0)} },
                lay = { type = 'layside', seats = {[1] = vector4(799.43, -825.76, 25.83, 90.0)} },
                poly = { center = vector3(799.43, -825.76, 25.83), length = 0.85, width = 2.2, height = 0.8 } 
            },
            ['ottos_sofa_5'] = {
                sit = { type = 'chair2', seats = {[1] = vector4(806.11, -825.11, 25.83, 90.0), [2] = vector4(806.11, -825.91, 25.83, 90.0)} },
                lay = { type = 'layside', seats = {[1] = vector4(806.11, -825.51, 25.83, 90.0)} },
                poly = { center = vector3(806.11, -825.51, 25.83), length = 0.85, width = 2.2, height = 0.8 } 
            }
        }
    },
    ...
    ['gabz_paleto_bank'] = {
		enabled = Config.PresetLocations.gabz_paleto_bank,
		center = vector3(-103.85, 6469.70, 31.14),
		radius = 20.0,
		polys = {
            -- Lobby
            ['paleto_bank_lobby_1'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(-104.62, 6468.89, 31.14, 63.0)} },
                poly = { length = 0.85, width = 0.85, height = 0.85 }
            },
            ['paleto_bank_lobby_2'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(-105.93, 6467.56, 31.14, 38.0)} },
                poly = { length = 0.85, width = 0.85, height = 0.85 }
            },
            ['paleto_bank_lobby_3'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(-111.04, 6464.34, 31.14, 26.0)} },
                poly = { length = 0.85, width = 0.85, height = 0.85 }
            },
            ['paleto_bank_lobby_4'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(-110.45, 6465.68, 31.14, 95.0)} },
                poly = { length = 0.85, width = 0.85, height = 0.85 }
            },
            ['paleto_bank_lobby_5'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(-98.33, 6471.84, 31.14, 135.0)} },
                poly = { length = 0.85, width = 0.85, height = 0.85 }
            },
            ['paleto_bank_lobby_5'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(-98.33, 6471.84, 31.14, 135.0)} },
            ...
            ['paleto_bank_lobby_6'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(-98.99, 6472.55, 31.14, 135.0)} },
                poly = { length = 0.85, width = 0.85, height = 0.85 }
            },
            ['paleto_bank_lobby_7'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(-101.57, 6475.14, 31.14, 135.0)} },
                poly = { length = 0.85, width = 0.85, height = 0.85 }
            },
            ['paleto_bank_lobby_8'] = { 
                sit = { type = 'chair', skipSeeCheck = true, teleportOut = true, seats = {[1] = vector4(-106.70, 6472.25, 31.14, 40.0)} },
                poly = { length = 1.0, width = 1.0, height = 1.0 }
            },
            ['paleto_bank_lobby_9'] = { 
                sit = { type = 'chair', skipSeeCheck = true, teleportOut = true, seats = {[1] = vector4(-105.71, 6473.22, 31.14, 58.0)} },
                poly = { length = 1.0, width = 1.0, height = 1.0 }
            },

            -- Administration Office
            ['paleto_bank_adm_1'] = { 
                sit = { type = 'chair', skipSeeCheck = true, seats = {[1] = vector4(-104.96, 6477.68, 31.14, 38.0)} },
                poly = { length = 1.0, width = 1.0, height = 1.0 }
            },
            ['paleto_bank_adm_2'] = { 
                sit = { type = 'chair', skipSeeCheck = true, seats = {[1] = vector4(-104.06, 6478.63, 31.14, 55.0)} },
                poly = { length = 1.0, width = 1.0, height = 1.0 }
            },

            -- Loans & Credit
            ['paleto_bank_lc_1'] = { 
                sit = { type = 'chair', skipSeeCheck = true, seats = {[1] = vector4(-103.67, 6462.12, 31.14, 218.0)} },
                poly = { length = 1.0, width = 1.0, height = 1.0 }
            },
            ['paleto_bank_lc_2'] = { 
                sit = { type = 'chair', skipSeeCheck = true, seats = {[1] = vector4(-104.61, 6461.17, 31.14, 235.0)} },
                poly = { length = 1.0, width = 1.0, height = 1.0 }
            },
            ['paleto_bank_lc_3'] = { 
                sit = { type = 'chair', skipSeeCheck = true, seats = {[1] = vector4(-98.09, 6467.76, 31.14, 218.0)} },
                poly = { length = 1.0, width = 1.0, height = 1.0 }
            },
            ['paleto_bank_lc_4'] = { 
                sit = { type = 'chair', skipSeeCheck = true, seats = {[1] = vector4(-99.05, 6466.80, 31.14, 235.0)} },
                poly = { length = 1.0, width = 1.0, height = 1.0 }
            }
        }
    },
    ...
    -- Fire Station 7
    ['gabz_el_burro_fire_station'] = {
		enabled = Config.PresetLocations.gabz_firedept,
		center = vector3(1205.89, -1473.55, 34.36),
		radius = 30.0,
		polys = {
            -- Lobby
            ['el_burro_fire_lobby_1'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(1189.75, -1465.29, 34.36, 180.0)} },
                poly = { length = 0.8, width = 1.0, height = 1.0 }
            },
            ['el_burro_fire_lobby_2'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(1190.87, -1465.26, 34.36, 180.0)} },
                poly = { length = 0.8, width = 1.0, height = 1.0 }
            },
            ['el_burro_fire_lobby_3'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(1192.27, -1466.60, 34.36, 90.0)} },
                poly = { length = 0.8, width = 1.0, height = 1.0 }
            },
            ['el_burro_fire_lobby_4'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(1192.28, -1467.80, 34.36, 90.0)} },
                poly = { length = 0.8, width = 1.0, height = 1.0 }
            },

            -- Kitchen
            ['el_burro_fire_kitchen_1'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(1213.65, -1469.47, 34.36, 176.0)} },
                poly = { length = 0.65, width = 0.65, height = 1.0 }
            },
            ['el_burro_fire_kitchen_2'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(1212.68, -1469.51, 34.36, 184.0)} },
                poly = { length = 0.65, width = 0.65, height = 1.0 }
            },
            ['el_burro_fire_kitchen_3'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(1211.51, -1470.85, 34.36, 285.0)} },
                poly = { length = 0.65, width = 0.65, height = 1.0 }
            },
            ['el_burro_fire_kitchen_4'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(1214.85, -1470.81, 34.36, 84.0)} },
                poly = { length = 0.65, width = 0.65, height = 1.0 }
            },
            ['el_burro_fire_kitchen_5'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(1211.33, -1467.50, 34.36, 5.0)} },
                poly = { length = 0.65, width = 0.65, height = 1.0 }
            },
            ['el_burro_fire_kitchen_6'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(1210.42, -1467.54, 34.36, 355.0)} },
                poly = { length = 0.65, width = 0.65, height = 1.0 }
            },
            ['el_burro_fire_kitchen_7'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(1212.37, -1466.20, 34.36, 105.0)} },
                poly = { length = 0.65, width = 0.65, height = 1.0 }
            },

            -- Kitchen Bench
            ['el_burro_fire_kitchen_b_1'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(1209.12, -1466.77, 34.36, 270.0), [2] = vector4(1209.12, -1466.02, 34.36, 270.0)} },
                poly = { center = vector3(1209.12, -1466.37, 34.36), length = 0.65, width = 1.60, height = 1.0 }
            },
            ['el_burro_fire_kitchen_b_2'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(1209.24, -1465.28, 34.36, 225.0)} },
                poly = { length = 0.65, width = 0.65, height = 1.0 }
            },
            ['el_burro_fire_kitchen_b_3'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(1209.92, -1465.17, 34.36, 180.0), [2] = vector4(1210.67, -1465.17, 34.36, 180.0), [3] = vector4(1211.32, -1465.17, 34.36, 180.0)} },
                poly = { center = vector3(1210.67, -1465.17, 34.36), length = 0.65, width = 2.2, height = 1.0 }
            },

            -- Shower Room (benches)
            ['el_burro_fire_shower_1'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(1213.16, -1482.38, 34.36, 270.0), [2] = vector4(1213.16, -1481.73, 34.36, 270.0), [3] = vector4(1213.16, -1481.08, 34.36, 270.0)} },
                poly = { center = vector3(1213.16, -1481.73, 34.36), length = 0.45, width = 2.2, height = 0.5 }
            },
            ['el_burro_fire_shower_2'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(1213.72, -1480.42, 34.36, 180.0), [2] = vector4(1214.37, -1480.42, 34.36, 180.0), [3] = vector4(1215.02, -1480.42, 34.36, 180.0)} },
                poly = { center = vector3(1214.37, -1480.42, 34.36), length = 0.45, width = 2.2, height = 0.5 }
            },
            ['el_burro_fire_shower_3'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(1217.57, -1481.00, 34.36, 90.0), [2] = vector4(1217.57, -1481.70, 34.36, 90.0)} },
                poly = { center = vector3(1217.57, -1481.35, 34.36), length = 0.45, width = 1.4, height = 0.5 }
            },

            -- Toilets
            ['el_burro_fire_toilet_1'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(1211.93, -1486.32, 34.36, 0.0)} },
                poly = { length = 0.65, width = 0.45, height = 1.0 }
            },
            ['el_burro_fire_toilet_2'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(1210.35, -1486.29, 34.36, 0.0)} },
                poly = { length = 0.65, width = 0.45, height = 1.0 }
            },

            -- Lockers
            ['el_burro_fire_locker_1'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(1209.47, -1472.18, 34.36, 180.0), [2] = vector4(1210.37, -1472.18, 34.36, 180.0), [3] = vector4(1211.37, -1472.18, 34.36, 180.0)} },
                poly = { center = vector3(1210.37, -1472.18, 34.36), length = 0.65, width = 2.45, height = 1.0 }
            },
            ['el_burro_fire_locker_2'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(1212.08, -1474.36, 34.36, 90.0), [2] = vector4(1212.08, -1475.21, 34.36, 90.0), [3] = vector4(1212.08, -1476.06, 34.36, 90.0)} },
                poly = { center = vector3(1212.08, -1475.21, 34.36), length = 0.65, width = 2.45, height = 1.0 }
            },

            -- Entertainment
            ['el_burro_fire_entertainment_1'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(1195.22, -1480.02, 34.36, 95.0)} },
                poly = { length = 1.15, width = 1.15, height = 1.0 }
            },
            ['el_burro_fire_entertainment_2'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(1195.25, -1482.03, 34.36, 85.0)} },
                poly = { length = 1.15, width = 1.15, height = 1.0 }
            },
            ['el_burro_fire_entertainment_3'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(1197.16, -1479.45, 34.36, 100.0)} },
                poly = { length = 1.15, width = 1.15, height = 1.0 }
            },
            ['el_burro_fire_entertainment_4'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(1197.37, -1481.00, 34.36, 90.0)} },
                poly = { length = 1.15, width = 1.15, height = 1.0 }
            },
            ['el_burro_fire_entertainment_5'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(1197.22, -1482.55, 34.36, 80.0)} },
                poly = { length = 1.15, width = 1.15, height = 1.0 }
            }
        }
    },
    ...
    ['gabz_davis_fire_station'] = {
		enabled = Config.PresetLocations.gabz_firedept,
		center = vector3(209.60, -1654.68, 29.31),
		radius = 30.0,
		polys = {
            -- Lobby
            ['davis_fire_lobby_1'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(202.55, -1637.96, 29.30, 140.0)} },
                poly = { length = 0.8, width = 1.0, height = 1.0 }
            },
            ['davis_fire_lobby_2'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(203.40, -1638.70, 29.30, 140.0)} },
                poly = { length = 0.8, width = 1.0, height = 1.0 }
            },
            ['davis_fire_lobby_3'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(203.63, -1640.63, 29.30, 50.0)} },
                poly = { length = 0.8, width = 1.0, height = 1.0 }
            },
            ['davis_fire_lobby_4'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(202.86, -1641.53, 29.30, 50.0)} },
                poly = { length = 0.8, width = 1.0, height = 1.0 }
            },

            -- Kitchen
            ['davis_fire_kitchen_1'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(218.15, -1656.58, 29.30, 136.0)} },
                poly = { length = 0.65, width = 0.65, height = 1.0 }
            },
            ['davis_fire_kitchen_2'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(217.41, -1655.96, 29.30, 145.0)} },
                poly = { length = 0.65, width = 0.65, height = 1.0 }
            },
            ['davis_fire_kitchen_3'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(215.64, -1656.25, 29.30, 245.0)} },
                poly = { length = 0.65, width = 0.65, height = 1.0 }
            },
            ['davis_fire_kitchen_4'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(218.20, -1658.35, 29.30, 44.0)} },
                poly = { length = 0.65, width = 0.65, height = 1.0 }
            },
            ['davis_fire_kitchen_5'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(217.67, -1653.56, 29.30, 325.0)} },
                poly = { length = 0.65, width = 0.65, height = 1.0 }
            },
            ['davis_fire_kitchen_6'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(216.95, -1653.00, 29.30, 315.0)} },
                poly = { length = 0.65, width = 0.65, height = 1.0 }
            },
            ['davis_fire_kitchen_7'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(219.27, -1653.23, 29.30, 65.0)} },
                poly = { length = 0.65, width = 0.65, height = 1.0 }
            },

            -- Kitchen Bench
            ['davis_fire_kitchen_b_1'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(216.52, -1651.45, 29.30, 230.0), [2] = vector4(216.96, -1650.91, 29.30, 230.0)} },
                poly = { center = vector3(216.74, -1651.18, 29.30), length = 0.65, width = 1.60, height = 1.0 }
            },
            ['davis_fire_kitchen_b_2'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(217.48, -1650.51, 29.30, 185.0)} },
                poly = { length = 0.65, width = 0.65, height = 1.0 }
            },
            ['davis_fire_kitchen_b_3'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(218.11, -1650.87, 29.30, 140.0), [2] = vector4(218.69, -1651.35, 29.30, 140.0), [3] = vector4(219.26, -1651.84, 29.30, 140.0)} },
                poly = { center = vector3(218.61, -1651.29, 29.30), length = 0.65, width = 2.2, height = 1.0 }
            },

            -- Shower Room (benches)
            ['davis_fire_shower_1'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(209.48, -1666.12, 29.35, 230.0), [2] = vector4(209.90, -1665.62, 29.35, 230.0), [3] = vector4(210.32, -1665.12, 29.35, 230.0)} },
                poly = { center = vector3(209.90, -1665.62, 29.35), length = 0.45, width = 2.2, height = 0.5 }
            },
            ['davis_fire_shower_2'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(211.16, -1665.00, 29.35, 140.0), [2] = vector4(211.66, -1665.42, 29.35, 140.0), [3] = vector4(212.16, -1665.84, 29.35, 140.0)} },
                poly = { center = vector3(211.66, -1665.42, 29.35), length = 0.45, width = 2.2, height = 0.5 }
            },
            ['davis_fire_shower_3'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(213.82, -1667.88, 29.35, 50.0), [2] = vector4(213.40, -1668.38, 29.35, 50.0)} },
                poly = { center = vector3(213.58, -1668.11, 29.35), length = 0.45, width = 1.4, height = 0.5 }
            },

            -- Toilets
            ['davis_fire_toilet_1'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(206.03, -1668.36, 29.30, 320.0)} },
                poly = { length = 0.65, width = 0.45, height = 1.0 }
            },
            ['davis_fire_toilet_2'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(204.80, -1667.35, 29.30, 320.0)} },
                poly = { length = 0.65, width = 0.45, height = 1.0 }
            },

            -- Lockers
            ['davis_fire_locker_1'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(213.32, -1656.04, 29.30, 140.0), [2] = vector4(213.97, -1656.59, 29.30, 140.0), [3] = vector4(214.62, -1657.14, 29.30, 140.0)} },
                poly = { center = vector3(213.97, -1656.59, 29.30), length = 0.65, width = 2.45, height = 1.0 }
            },
            ['davis_fire_locker_2'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(213.84, -1659.30, 29.30, 50.0), [2] = vector4(213.29, -1659.95, 29.30, 50.0), [3] = vector4(212.74, -1660.60, 29.30, 50.0)} },
                poly = { center = vector3(213.29, -1659.95, 29.30), length = 0.65, width = 2.45, height = 1.0 }
            },

            -- Entertainment
            ['davis_fire_entertainment_1'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(197.22, -1652.77, 29.30, 55.0)} },
                poly = { length = 1.15, width = 1.15, height = 1.0 }
            },
            ['davis_fire_entertainment_2'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(195.96, -1654.31, 29.30, 45.0)} },
                poly = { length = 1.15, width = 1.15, height = 1.0 }
            },
            ['davis_fire_entertainment_3'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(199.14, -1653.62, 29.30, 60.0)} },
                poly = { length = 1.15, width = 1.15, height = 1.0 }
            },
            ['davis_fire_entertainment_4'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(198.28, -1654.92, 29.30, 50.0)} },
                poly = { length = 1.15, width = 1.15, height = 1.0 }
            },
            ['davis_fire_entertainment_5'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(197.16, -1656.00, 29.30, 40.0)} },
                poly = { length = 1.15, width = 1.15, height = 1.0 }
            }
        }
    },
    ...
    -- Families
    ['gabz_families'] = {
		enabled = Config.PresetLocations.gabz_families,
		center = vector3(-153.75, -1613.90, 33.15),
		radius = 20.0,
		polys = {
            ['families_toilet_1'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(-151.54, -1615.80, 33.15, 160.0)} },
                poly = { length = 0.75, width = 0.5, height = 0.5 }
            },
            ['families_toilet_2'] = { 
                sit = { type = 'chair2', seats = {[1] = vector4(-149.83, -1616.44, 33.15, 160.0)} },
                poly = { length = 0.75, width = 0.5, height = 0.5 }
            },
            ['families_chair'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(-154.65, -1614.41, 33.15, 325.0)} },
                poly = { length = 1.25, width = 1.25, height = 1.0 }
            },
            ['families_office_couch'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(-163.85, -1614.49, 33.15, 160.0), [2] = vector4(-163.09, -1614.77, 33.15, 160.0)} },
                lay = { type = 'layside', seats = {[1] = vector4(-163.47, -1614.63, 33.15, 160.0)} },
                poly = { center = vector3(-163.47, -1614.63, 33.15), length = 1.0, width = 2.30, height = 1.1 }
            },
            ['families_couch_1'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(-152.06, -1612.82, 33.15, 70.0), [2] = vector4(-152.28, -1613.43, 33.15, 70.0), [3] = vector4(-152.50, -1614.04, 33.15, 70.0)} },
                lay = { type = 'layside', seats = {[1] = vector4(-152.28, -1613.43, 33.15, 70.0)} },
                poly = { center = vector3(-152.28, -1613.43, 33.15), length = 0.8, width = 1.90, height = 1.1 }
            },
            ['families_couch_2'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(-151.78, -1611.94, 33.15, 70.0)} },
                lay = { type = 'layside', seats = {[1] = vector4(-151.59, -1611.72, 33.15, 70.0)} },
                poly = { center = vector3(-151.78, -1611.94, 33.15), length = 0.8, width = 1.30, height = 1.1 }
            },
            ['families_couch_3'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(-153.03, -1610.49, 33.15, 160.0), [2] = vector4(-152.27, -1610.77, 33.15, 160.0)} },
                lay = { type = 'layside', seats = {[1] = vector4(-152.65, -1610.63, 33.15, 160.0)} },
                poly = { center = vector3(-152.65, -1610.63, 33.15), length = 0.8, width = 1.90, height = 1.1 }
            }
        }
    },
    ...
    -- Bobcat
    ['gabz_bobcat'] = {
		enabled = Config.PresetLocations.gabz_bobcat,
		center = vector3(914.35, -2114.75, 30.73),
		radius = 15.0,
		polys = {
            ['bobcat_couch_1'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(914.67, -2115.90, 30.73, 85.0), [2] = vector4(914.61, -2116.60, 30.73, 85.0)} },
                poly = { center = vector3(914.64, -2116.25, 30.73), length = 0.7, width = 1.60, height = 1.0 }
            },
            ['bobcat_couch_2'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(914.86, -2114.35, 30.73, 85.0), [2] = vector4(914.80, -2115.05, 30.73, 85.0)} },
                poly = { center = vector3(914.83, -2114.70, 30.73), length = 0.7, width = 1.60, height = 1.0 }
            },
            ['bobcat_couch_3'] = { 
                sit = { type = 'chair', seats = {[1] = vector4(913.25, -2113.28, 30.73, 175.0), [2] = vector4(913.95, -2113.34, 30.73, 175.0)} },
                poly = { center = vector3(913.60, -2113.31, 30.73), length = 0.7, width = 1.60, height = 1.0 }
            },
        }
    }
}
