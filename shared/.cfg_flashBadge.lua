config = {
    useESX = true, -- If you are using this script for an ESX server set this to true, if not leave it at false
    ...
    commandName = 'poli', -- The name of the command used to flash your badge
