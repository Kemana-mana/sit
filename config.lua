...
-- Debugmodes
Config.Debugmode = false -- General debugging, shows what seats/beds you can sit/lay on and the direction you will be facing, also enables debugging commands.
Config.DebugPoly = false -- This is not advised unless you have set your PolyZone script set to only render polys nearby

-- Whether or not to use GTA's default notifiaction system, it will otherwise use mythic notify (can be changed)
Config.UseNativeNotifiactions = true
...
Config.Lang = {
    ...
    KeyMapping = {
        ...
        SitDown = "Tekan %s duduk",
        LayDown = "Tekan %s Tidur",
        GetUp = "Tekan %s Berdiri"
    },

    -- Description in Settings>Key Bindings>Fivem
    KeyBindingDesc = {
        Keyboard = {
            SitDown = "Duduk Di Kursi",
            LayDown = "Berbaring Di Tempat Tidur/Bangku",
            GetUp = "Bangun Dari Kursi/Tempat Tidur"
        },
        PadAnalog = {
...
-- Which preset locations that should be loaded. (gabz team mlo's are loaded by default)
...
Config.RadioListVisibilityCommand = "rlist" 	-- Only works if Config.LetPlayersChangeVisibilityOfRadioList is set to true

Config.LetPlayersSetTheirOwnNameInRadio = false			-- Let players to customize how their name is displayed on the list
Config.ResetPlayersCustomizedNameOnExit = false		-- Only works if Config.LetPlayersSetTheirOwnNameInRadio is set to true - Removes customized name players set for themselves on their server exit
Config.RadioListChangeNameCommand = "jonn" 	-- Only works if Config.LetPlayersSetTheirOwnNameInRadio is set to true
